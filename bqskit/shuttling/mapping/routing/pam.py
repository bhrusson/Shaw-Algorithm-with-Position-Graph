"""This module implements the ShuttlingPAMRoutingPass."""
...
from bqskit.shuttling.mapping.pam import PAMBlockZTAPermData
from bqskit.shuttling.mapping.pam import ShuttlingPermutationAwareMappingAlgorithm

_logger = logging.getLogger(__name__)


class PAMRoutingPass(ShuttlingPermutationAwareMappingAlgorithm, BasePass):
    ...
    async def run(self, circuit: Circuit, data: PassData) -> None:
        ...
        perm_data: dict[CircuitPoint, PAMBlockZTAPermData] = {}
