...
# Mid-sized version of the long benchmark. This is intended to land closer
# to the "few minutes" range rather than the ~hour-scale run of the full one.
MACHINE_TYPE = 'linear'
TRAP_CAPACITY = 6
NUM_TRAPS = 24
NUM_IONS = 72
...
def build_test_gates(num_ions: int) -> list[Operation]:
    if num_ions < 12:
        raise ValueError('Need at least 12 ions for the medium benchmark.')
