...
"""This module implements the SHAPER algorithm."""
...
class PermutationAwareQCCDMappingAlgorithm(QCCDMappingAlgorithm):
    """
        ...
        modified heuristic to accommodate larger than 2-qudit gates. (SHAPER)
...
if __name__ == '__main__':
    ...
    mapping_algo = PermutationAwareQCCDMappingAlgorithm(qccd_machine=machine_model,
                                                        decay_delta=0.0,
                                                        extended_set_size=5,
